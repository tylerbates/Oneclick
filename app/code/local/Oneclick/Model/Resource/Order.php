...
/**
 * Extend magento resource model
 * to add resource order model
 *
 *
 * @category   Oggetto
 * @package    Oggetto_Oneclick
 ...
 */
class Oggetto_Oneclick_Model_Resource_Order extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Model constructor
     *
    ...
    {
        $this->_init('oggetto_oneclick/orders', 'order_id');
    }
}